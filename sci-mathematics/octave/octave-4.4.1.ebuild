...
IUSE="curl doc fftw +glpk gnuplot graphicsmagick gui hdf5 +imagemagick java libressl opengl
	portaudio postscript +qhull +qrupdate qt4 readline sndfile +sparse ssl static-libs X zlib"
...
RDEPEND="
	...
	gui? (
		...
		qt4? (
			...
			dev-qt/qthelp:4
			dev-qt/qtopengl:4
			>=x11-libs/qscintilla-2.9.3-r2:=[qt4(+)]
		)
	)
...
DEPEND="${RDEPEND}
	...
	gui? ( !qt4? ( dev-qt/linguist-tools:5 ) )
