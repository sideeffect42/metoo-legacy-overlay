...
IUSE="doc fax +hpcups hpijs kde libressl libnotify -libusb0 minimal parport policykit qt4 qt5 scanner +snmp static-ppds X"

COMMON_DEPEND="
	>=net-print/cups-1.1.15
	virtual/jpeg:0
...
RDEPEND="${COMMON_DEPEND}
	...
	!minimal? (
		...
		qt4? ( >=dev-python/PyQt4-4.9.6-r2[dbus,X,${PYTHON_USEDEP}] )
